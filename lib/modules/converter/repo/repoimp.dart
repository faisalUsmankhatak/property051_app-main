...
class AreaConverterImpl implements AreaConverter {
  var sqFtValues = [1, 0.092903, 0.111111, 0.0000229568, 0.000247105];
  @override
  List convertUnit(selectedUnit, area, marlaSize) {
    print('selectedUnit: $selectedUnit, area: $area, marlaSize: $marlaSize');
    var values = [];
