...
import 'perssonviewmodel.dart';

class PersonTradeView extends StatelessWidget {
  String? title;
  String? id;
  var tradeViewModel = Get.put(PersonTradeViewModel());

  PersonTradeView({required this.title, this.id}) {
    title = title;
